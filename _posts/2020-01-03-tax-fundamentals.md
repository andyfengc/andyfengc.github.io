...
# 报完税需要更改怎么办？
在完成报税单之后的几天之后，有客户又提供了一些可以抵税项目的收据，例如购买药物的收据，这样抵税额度就会发生变化，相应的资料也需要更改。如果采用网上报税或是电话报税方法的话，就会很麻烦再找到报税人档案进行修改。所以很多会计师通常在完成填表后，会將客户的档案搁置几天，確保没有新的变化后，再將其寄出。 
...
# 更改以前的报税
有些减税项目，以前报税时候忘记了，其实可以补报，能把前几年的税退回来。有如下方法（任选其一即可）：
